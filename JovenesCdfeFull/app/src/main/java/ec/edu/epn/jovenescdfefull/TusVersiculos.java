...
public class TusVersiculos extends AppCompatActivity {
    ListView cancion;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_tus_versiculos);
        cancion = (ListView) findViewById(R.id.list_view_versiculo);
    }
    public void cargarVersiculo (View view){
        List<String> letraCancion = new ArrayList<String>();
        String linea;
        InputStream is = this.getResources().openRawResource(R.raw.navidad_versiculo);
